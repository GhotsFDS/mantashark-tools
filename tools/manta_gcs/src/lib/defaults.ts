...
export const DEFAULT_PARAMS: ParamSet = {
  ...
  // P7.9.28: TL2/TR2 (硬件已装 SERVO20/21, 锁 GOAL=90°, dir_default=0 未校准锁)
  TLT_TL2_ZERO:  1500, TLT_TL2_DIR:  0, TLT_TL2_LMIN: -45, TLT_TL2_LMAX:  45,
  TLT_TR2_ZERO:  1500, TLT_TR2_DIR:  0, TLT_TR2_LMIN: -45, TLT_TR2_LMAX:  45,
  ...
  TLT_SGRP_GOAL: 50,
  TLT_TL2_GOAL:  90, TLT_TR2_GOAL:  90,
